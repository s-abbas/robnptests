...
For a more detailed description of the asymptotic behaviour of M-estimators, we refer to @MarMarYoh06robu[p. 36ff.], which we use as the main reference for the following motivation.
...
For M-estimators $\hat{\mu}_X$ and $\hat{\mu}_Y$ with a $\psi$-function $\psi$, it can be shown that
\begin{align*}
