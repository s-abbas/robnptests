...
The $p$-value corresponds to the fraction of computed values of the test statistic,
which are at least as extreme as the observed value, represented by $A$ in the following.
Let $t_i$ be the value of the test statistic for split $i$, $i = 1, \ldots, B$, and $t^{(\text{obs})}$
...
```{r, cache = TRUE}
hl1.res <- hl1_test(x = x, y = y, alternative = "two.sided", delta = 0, method = "permutation", scale = "S2")
