...
------------- | ----------- | ----------
`med_test`    | Tests based on the difference of the sample medians | [@FriDeh11robu]
`hl1_test`    | Tests based on the one-sample Hodges-Lehmann estimator | [@FriDeh11robu]
`hl2_test`    | Tests based on the two-sample Hodges-Lehmann estimator | [@FriDeh11robu]
...
and efficiency are the Hodges-Lehmann estimators [@HodLeh64est].
