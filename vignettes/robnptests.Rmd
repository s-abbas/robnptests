...
With these transformed samples, we are again in the data situation described above as the distributions differ at most by  \[ \Delta_0 = \log(F\tilde{\Delta}_0) = \log\left(\sigma_X^2\right) - \log\left(\sigma_Y^2\right)\] [see @Fri12onli].
