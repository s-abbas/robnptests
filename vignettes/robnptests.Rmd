...
As described in the introduction, setting `var.test = TRUE` transforms the observations so that a possible scale difference between the samples appears as a location difference between the transformed samples. For these tests, the samples need to be centred beforehand.
...
#>  [1] gtools_3.9.3      statmod_1.4.36    xfun_0.31         remotes_2.4.2     purrr_0.3.4       miniUI_0.1.1.1    usethis_2.1.6     htmltools_0.5.2   yaml_2.3.5       
#> [10] rlang_1.0.4       pkgbuild_1.3.1    urlchecker_1.0.1  later_1.3.0       glue_1.6.2        withr_2.5.0       sessioninfo_1.2.2 lifecycle_1.0.1   robustbase_0.95-0
#> [19] stringr_1.4.0     devtools_2.4.4    htmlwidgets_1.5.4 codetools_0.2-18  memoise_2.0.1     evaluate_0.15     knitr_1.39        callr_3.7.1       fastmap_1.1.0    
#> [28] httpuv_1.6.5      ps_1.7.1          DEoptimR_1.0-11   Rcpp_1.0.9        xtable_1.8-4      promises_1.2.0.1  backports_1.4.1   checkmate_2.1.0   cachem_1.0.6     
#> [37] desc_1.4.1        pkgload_1.3.0     mime_0.12         fs_1.5.2          brio_1.1.3        digest_0.6.29     stringi_1.7.6     processx_3.7.0    shiny_1.7.2      
#> [46] rbibutils_2.2.8   rprojroot_2.0.3   Rdpack_2.4        cli_3.3.0         tools_4.2.2       magrittr_2.0.3    profvis_0.3.7     rticles_0.23      crayon_1.5.1     
#> [55] ellipsis_0.3.2    prettyunits_1.1.1 rmarkdown_2.14    rstudioapi_0.13   R6_2.5.1          compiler_4.2.2
```
