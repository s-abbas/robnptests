...
#### Asymptotic M-test
For details on the asymptotic M-test see the vignette [Construction of the M-tests](m_tests.pdf).
...
#> [1] robnptests_0.1.0 testthat_3.0.2  
#> 
#> loaded via a namespace (and not attached):
#>  [1] compiler_4.0.3    DEoptimR_1.0-8    prettyunits_1.1.1 remotes_2.3.0     tools_4.0.3       digest_0.6.27     packrat_0.6.0     pkgbuild_1.2.0    pkgload_1.2.1     statmod_1.4.35   
#> [11] evaluate_0.14     memoise_2.0.0     lifecycle_1.0.0   checkmate_2.0.0   rlang_0.4.10      cli_2.4.0         rstudioapi_0.13   xfun_0.22         fastmap_1.1.0     withr_2.4.2      
#> [21] stringr_1.4.0     knitr_1.33        desc_1.3.0        fs_1.5.0          gtools_3.8.2      devtools_2.4.0    rprojroot_2.0.2   glue_1.4.2        robustbase_0.93-7 R6_2.5.0         
#> [31] processx_3.5.1    Rdpack_2.1.1      sessioninfo_1.1.1 callr_3.7.0       purrr_0.3.4       magrittr_2.0.1    codetools_0.2-16  backports_1.2.1   ps_1.6.0          ellipsis_0.3.1   
#> [41] rbibutils_2.1     usethis_2.0.1     stringi_1.5.3     cachem_1.0.1      crayon_1.4.1
```
