---
<<<<<<< Updated upstream:vignettes/robnptests.Rmd
title: "Getting started with `robnptests`"
date: "2021-04-27"
=======
title: "Getting started with `robTests`"
date: "2021-05-30"
>>>>>>> Stashed changes:vignettes/robTests.Rmd
...
With these transformed samples, we are again in the data situation described above as the distributions differ at most by  ß[ \Delta_0 = \log(F\tilde{\Delta}_0) = \log\left(\sigma_X^2\right) - \log\left(\sigma_Y^2\right)\] [see @Fri12onli].
...
library(robnptests)
=======
library(robTests) # library(robnptests)
>>>>>>> Stashed changes:vignettes/robTests.Rmd
...
#>  [1] compiler_4.0.2 magrittr_1.5   tools_4.0.2    stringi_1.4.6  knitr_1.29    
#>  [6] gbRd_0.4-11    digest_0.6.25  xfun_0.16      stringr_1.4.0  bibtex_0.4.2.2
#> [11] packrat_0.5.0  Rdpack_1.0.0   evaluate_0.14
```
