...
#' Two-sample location tests based on the difference of the one-sample Hodges-Lehmann
#' estimators of the two samples.
#' 
#' @description 
#' \code{hl1_test} performs a two-sample test for the location shift based on
